...
Boost_clf = AdaBoostClassifier(base_estimator=DT_clf,n_estimators = 50, learning_rate = 1)
...
#==============================================================================
DT_clf = DecisionTreeClassifier(max_depth=6, min_samples_leaf=1)
...
plt.figure(3)
plt.title("Accuracy VS n_estimators (max_depth=6)")
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('Boosting_sample_B_Validation_Curve_n_estimators_max_depth_6.png',dpi=600)
plt.show()
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('Boosting_sample_B_Validation_Curve_n_estimators_max_depth_1.png',dpi=600)
plt.show()
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('Boosting_sample_B_Validation_Curve_n_estimators_max_depth_3.png',dpi=600)
plt.show()
#==============================================================================
...
plt.xlabel('Training set size')
#plt.xlabel('Training set size', fontsize = 14)
plt.title('Learning Curves for Boosting (max_depth=6)', y = 1.03)
plt.legend()
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('Boosting_sample_B_Learning_curves_max_depth_6.png',dpi=600)
...
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('Boosting_sample_B_Learning_curves_max_depth_3.png',dpi=600)
...
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('Boosting_sample_B_Learning_curves_max_depth_1.png',dpi=600)
...
print('\n', '-' * 50)
print('After hyperparameter tunning, max_depth=6')
