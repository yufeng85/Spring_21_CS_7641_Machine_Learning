...
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('SVM_sample_B_Learning_curves_default_setting.png',dpi=600)


#==============================================================================
#Gid search
#==============================================================================
parameters = {'C':np.logspace(-2, 5, 8)}
...
# Best score is:  0.9927065172270652

#==============================================================================
parameters = {'C':np.logspace(-2, 6, 9), 'gamma':np.logspace(-9, 3, 13)}
...
print ('Best parameters are: ',best_params)
print ('Best score is: ',best_score)
# Best parameters are:  {'C': 10000.0, 'gamma': 0.001}
# Best score is:  0.9927065172270652
...
print ('Best parameters are: ',best_params)
print ('Best score is: ',best_score)
# Best parameters are:  {'C': 1.0, 'gamma': 1.0}
# Best score is:  1.0

#==============================================================================
#parameters = {'C':np.logspace(-2, -1, 2), 'gamma':np.logspace(-2, -1, 2), 'degree':[2,3,4,5]}
...
print ('Best parameters are: ',best_params)
print ('Best score is: ',best_score)
# Best parameters are:  {'degree': 3}
# Best score is:  0.9881361560813616
...
plt.imshow(scores, interpolation='nearest', cmap=plt.cm.hot,
            norm=MidpointNormalize(vmin=0.4, midpoint=0.985))
plt.xlabel('gamma')
plt.ylabel('C')
plt.colorbar()
...
plt.grid(False)
plt.savefig('SVM_sample_B_Grid_search.png',dpi=600)
plt.show()
...
train_scores, test_scores = validation_curve(
    SVC(C=1), X = x_train, y = y_train.values.ravel(), param_name="gamma", param_range=param_range,
...
plt.fill_between(param_range, test_scores_mean - test_scores_std,
                  ...
                  color="navy", lw=lw)
plt.legend(loc="best")
plt.savefig('SVM_sample_B_Validation_Curve_gamma.png',dpi=600)
plt.show()
...
train_scores, test_scores = validation_curve(
    SVC(gamma=1), X = x_train, y = y_train.values.ravel(), param_name="C", param_range=param_range,
    scoring="accuracy", n_jobs=1)
train_scores_mean = np.mean(train_scores, axis=1)
train_scores_std = np.std(train_scores, axis=1)
test_scores_mean = np.mean(test_scores, axis=1)
...
plt.fill_between(param_range, test_scores_mean - test_scores_std,
                  ...
                  color="navy", lw=lw)
plt.legend(loc="best")
plt.savefig('SVM_sample_B_Validation_Curve_C.png',dpi=600)
plt.show()
...
#print (train_sizes)
SVM_clf = SVC(random_state=0, C=1, gamma=1)
train_sizes, train_scores, validation_scores = learning_curve(
estimator = SVM_clf,
X = x_train,
y = y_train.values.ravel(), train_sizes = train_sizes, cv = 5,
...
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('SVM_sample_B_Learning_curves_after_hyper_parameter_tuning.png',dpi=600)
...
print('\n', '-' * 50)
print('After hyperparameter tunning, C=1, gamma=1')
