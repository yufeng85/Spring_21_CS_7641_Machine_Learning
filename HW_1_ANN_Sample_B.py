...
estimator = MLPClassifier(solver='sgd',activation = 'logistic',max_iter = 3000,alpha = 1e-4,hidden_layer_sizes = (100),random_state = 0),
X = x_train,
...
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('ANN_sample_B_Learning_curves_for_ANN_Default_setting.png',dpi=600)
...
plt.grid(False)
plt.savefig('ANN_sample_B_Grid_search.png',dpi=600)
plt.show()
...
#==============================================================================
MLP_clf = MLPClassifier(solver='sgd',activation = 'logistic', alpha = 1e-4,hidden_layer_sizes = (60),random_state = 0)
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('ANN_sample_B_Validation_Curve_Max_iteration.png',dpi=600)
plt.show()
...
MLP_clf = MLPClassifier(solver='sgd',activation = 'logistic', max_iter = 5000, alpha = 1e-4, random_state = 0)
param_range = [20, 40, 60, 80, 100, 140, 160, 180, 200, 250, 300]
train_scores, test_scores = validation_curve(
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('ANN_sample_B_Validation_Curve_hidden_layer_sizes_logistic.png',dpi=600)
plt.show()
...
plt.grid(True)
plt.xscale('log')
plt.savefig('ANN_sample_B_Validation_Curve_alpha.png',dpi=600)
plt.show()
...
MLP_clf = MLPClassifier(solver='sgd',activation = 'logistic', max_iter = 5000, alpha = 1e-4, random_state = 0)
param_range = [(60,),(60,2), (60,4), (60,6), (60,8), (60,10), (60,15), (60,20), (60,50), (60,100), (60,150)]
train_scores, test_scores = validation_curve(
    MLP_clf, X = x_train, y = y_train.values.ravel(), param_name='hidden_layer_sizes', param_range=param_range,
    scoring="accuracy")
train_scores_mean = np.mean(train_scores, axis=1)
...
plt.grid(True)
#plt.xscale('log')
plt.savefig('ANN_sample_B_Validation_Curve_second_hidden_layer_sizes.png',dpi=600)
plt.show()
...
MLP_clf = MLPClassifier(solver='sgd',activation = 'tanh', max_iter = 5000, alpha = 1e-4, random_state = 0)
param_range = [20, 40, 60, 80, 100, 140, 160, 180, 200, 250, 300]
train_scores, test_scores = validation_curve(
    MLP_clf, X = x_train, y = y_train.values.ravel(), param_name='hidden_layer_sizes', param_range=param_range,
    scoring="accuracy")
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('ANN_sample_B_Validation_Curve_hidden_layer_sizes_tanh.png',dpi=600)
plt.show()
...
MLP_clf = MLPClassifier(solver='sgd',activation = 'relu', max_iter = 5000, alpha = 1e-4, random_state = 0)
param_range = [20, 40, 60, 80, 100, 140, 160, 180, 200, 250, 300]
train_scores, test_scores = validation_curve(
    MLP_clf, X = x_train, y = y_train.values.ravel(), param_name='hidden_layer_sizes', param_range=param_range,
    scoring="accuracy")
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('ANN_sample_B_Validation_Curve_hidden_layer_sizes_relu.png',dpi=600)
plt.show()
...
MLP_clf = MLPClassifier(solver='sgd',activation = 'logistic', max_iter = 3000, hidden_layer_sizes = 60, random_state = 0)
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('ANN_sample_B_Validation_Curve_momentum.png',dpi=600)
plt.show()
...
for momentum in momentums:
    MLP_clf = MLPClassifier(solver='sgd',activation = 'logistic', max_iter = 3000, hidden_layer_sizes = 60, random_state = 0, momentum=momentum)
    MLP_clf.fit(x_train, y_train.values.ravel())
    clfs.append(MLP_clf)
...
#plt.legend(loc="best")
plt.grid(True)
plt.savefig('ANN_sample_B_momentum_VS_Iteration.png',dpi=600)
plt.show()
...
train_sizes, train_scores, validation_scores = learning_curve(
estimator = MLPClassifier(solver='sgd',activation = 'logistic',max_iter = 3000,alpha = 1e-4,hidden_layer_sizes = (60),random_state = 0,momentum=0.9),
X = x_train,
y = y_train.values.ravel(), train_sizes = train_sizes, cv = 5,
scoring = 'accuracy',
shuffle = True,
...
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('ANN_sample_B_Learning_curves_for_ANN_after_hyper_parameter_tuning.png',dpi=600)
...
print('\n', '-' * 50)
print('After hyperparameter tunning, max_iter = 1500, alpha = 1e-4,hidden_layer_sizes = (60)')

start_1 = time.time()
MLP_clf = MLPClassifier(solver='sgd',activation = 'logistic',max_iter = 1500,alpha = 1e-4,hidden_layer_sizes = (60),random_state = 0)
MLP_clf.fit(x_train, y_train.values.ravel())
end_1 = time.time()
